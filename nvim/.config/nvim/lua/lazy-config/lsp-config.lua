local function on_attach()
  ...
  vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(ev)
      ...
      -- Formattting handled by formatter.nvim
...
return {
  ...
  },
  {
    ...
    opts = {
      ensure_installed = {
        ...
        "luacheck",
        "stylua",
        "taplo", -- For formatting, not for lsp
        "ruff",
        "black",
        "hadolint",
        "cspell",
  ...
  },
  {
    ...
    config = function()
      ...
      local filetypes_mod = require("formatter.filetypes")
      local util = require("formatter.util")

      local filetype = {
        lua = { filetypes_mod["lua"].stylua },
        toml = { filetypes_mod["toml"].taplo },
        python = {
          function()
            return {
              exe = "ruff",
          ...
          filetypes_mod["python"].black,
        },
        ["*"] = { filetypes_mod["any"].remove_trailing_whitespace },
      }

      fmt.setup({ logger = true, log_level = vim.log.levels.DEBUG, filetype = filetype })
      vim.api.nvim_create_autocmd({ "BufWritePost" }, {
        group = vim.api.nvim_create_augroup("UserFormatterConfig", {}),
        command = "FormatWrite",
      })
    end,
  },
